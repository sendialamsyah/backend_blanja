...
//product
CREATE TABLE product(id INT PRIMARY KEY GENERATED ALWAYS AS IDENTITY, name VARCHAR(64) NOT NULL, description VARCHAR(128), price INT DEFAULT 0, stock INT DEFAULT 0, category_id INT NOT NULL);
